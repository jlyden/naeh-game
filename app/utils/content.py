tips = {
    ...
    'otip': 'Connects with people living on the street, providing food, clothing, sometimes housing options',
    'ttip': 'Temporary housing (up to 24 months) with required services and case management',
    'ptip': 'Often serves people experiencing chronic homelessness and/or disability',
}
