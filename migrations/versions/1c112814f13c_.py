...
Revision ID: 1c112814f13c
Revises: 
Create Date: 2017-08-12 02:23:35.532373
...
def upgrade():
    ...
    sa.Column('game_id', sa.Integer(), nullable=True),
    sa.Column('round_count', sa.Integer(), nullable=False),
    sa.Column('to_emerg', sa.Integer(), nullable=True),
    sa.Column('to_rapid', sa.Integer(), nullable=True),
    sa.Column('to_trans', sa.Integer(), nullable=True),
    sa.Column('to_perm', sa.Integer(), nullable=True),
    sa.Column('to_market', sa.Integer(), nullable=True),
    sa.Column('to_unshel', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['game_id'], ['game.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('log',
    ...
    sa.Column('game_id', sa.Integer(), nullable=True),
    sa.Column('round_count', sa.Integer(), nullable=False),
    sa.Column('from_board', sa.Integer(), nullable=False),
    sa.Column('to_board', sa.Integer(), nullable=False),
