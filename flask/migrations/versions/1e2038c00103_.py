...
Revision ID: 1e2038c00103
Revises:
Create Date: 2017-03-12 00:48:47.861224
...
def upgrade():
    ...
    op.create_index(op.f('ix_game_team_name'), 'game', ['team_name'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('score')
    op.drop_index(op.f('ix_game_team_name'), table_name='game')
    op.drop_table('game')
    # ### end Alembic commands ###
